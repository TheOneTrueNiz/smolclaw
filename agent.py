...
Architecture (v0.9.0 — deterministic state machines, structured I/O):
  - NUC1 (nizbot1, 10.0.0.1): Actor — state machine dispatcher, tool execution
  - NUC2 (nizbot2, 10.0.0.2): Critic — safety, grounding, contradiction detection
  - NUC3 (nizbot3, 10.0.0.3): Memory — smart recall, failure analysis, reflection
...
LLAMA_URL = "http://127.0.0.1:8090/v1/chat/completions"       # nizbot1 — actor/planner
CRITIC_URL = "http://10.0.0.2:8090/v1/chat/completions"      # nizbot2 — critic/grounding/contradictions
MEMORY_URL = "http://10.0.0.3:8090/v1/chat/completions"      # nizbot3 — memory/retrieval/reflection
...
def main():
    ...
    nodes = [
        ("NUC1/Actor  (local)",    "http://127.0.0.1:8090",  True),
        ("NUC2/Critic (10.0.0.2)", "http://10.0.0.2:8090",   False),
        ("NUC3/Memory (10.0.0.3)", "http://10.0.0.3:8090",   False),
    ]
